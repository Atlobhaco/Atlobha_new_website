            ...
            <Box>
              ...
              >
                ...
                <ul>
                  ...
                  <li style={{ marginBottom: "7px" }}>
                    عند إتمام طلبك واستلامه، سيتم إضافة نسبة من قيمة مشترياتك
                    تلقائيا إلى محفظتك . داخل التطبيق
                  </li>
                  <li style={{ marginBottom: "7px" }}>
                    يمكنك استخدام رصيد الكاش باك لشراء أي منتجات داخل التطبيق
                    فقط، ولا يمكن سحبه .نقدا
                  </li>
                  <li style={{ marginBottom: "7px" }}>
                    الرصيد صالح لفترة محددة، وبعد انتهاء هذه الفترة يتم إلغاؤه
                    تلقائيا
                  </li>
                  <li style={{ marginBottom: "7px", fontWeight: "bold" }}>
                  ...
                  <li style={{ marginBottom: "7px" }}>
                    قد تحتاج إلى الوصول إلى حد أدنى لقيمة السلة الشرائية لتفعيل
                    الكاش باك، وسيتم توضيحه أثناء العروض أو الحملات
                  </li>

                  <li style={{ marginBottom: "7px" }}>
                    الكاش باك يمنح فقط عند الشراء من أقسام محددة داخل التطبيق،
                    حسب ما يعلن خلال العروض.
                  </li>
                  <li style={{ marginBottom: "7px" }}>
                  ...
                  <li style={{ marginBottom: "7px" }}>
                    تحتفظ إدارة اطلبها بحق تعديل أو إيقاف برنامج الكاش باك في أي
                    وقت دون إشعار مسبق.{" "}
                  </li>
                  <li style={{ marginBottom: "7px" }}>
                    الرصيد يضاف في أقرب وقت بعد تأكيد التسليم، ويمكنك دائما
                    مراجعة رصيدك وتاريخه داخل التطبيق .
                  </li>

                  <li style={{ marginBottom: "7px" }}>
                    الاستخدام العادل أي محاولة لاستغلال الكاش باك بطريقة غير
                    قانونية قد تؤدي إلى إلغاء .الرصيد{" "}
                  </li>
                  <li style={{ marginBottom: "7px" }}>
                    العروض الخاصة بالكاش باك قد تشمل شروط إضافية، وسيتم توضيحها
                    في كل حملة{" "}
                  </li>
                </ul>
              </Box>
