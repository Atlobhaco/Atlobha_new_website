...
function ProductsExpress() {
  ...
  const returnUrlDependOnCar = () => {
    ...
    const baseParams = `has_express_delivery=true&page=${page}&per_page=${
      isMobile ? 12 : 20
              ...
              {isLoading || !allProducts ? (
                ...
                <>
                  {allProducts?.map((prod) => (
                    <div
                      className={`${isMobile ? "col-4" : "col-3"} mb-3 d-flex justify-content-center px-0`}
                      key={prod?.id}
                    >
