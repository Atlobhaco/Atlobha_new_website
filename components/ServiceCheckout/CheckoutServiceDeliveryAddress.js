...
function CheckoutServiceDeliveryAddress({
  orderDetails = {},
  callSingleOrder = () => {},
  ...
  const { data, isFetching } = useCustomQuery({
    name: ["changeOrderDeliveryAddress", newAddressId],
      ...
      >
        ...
        <div className={`${style["deliverySec_address"]}`}>
          ...
          {orderDetails?.address?.address ? (
            ...
            <Box
              sx={{
                background: "rgba(133, 217, 71, 0.10)",
                width: "fit-content",
...
export default CheckoutServiceDeliveryAddress;
